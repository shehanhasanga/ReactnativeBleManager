            ...
            <View
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <CircularTextButton title={"Pulsated"} callback={() => {sendPatternChangeCommand(0)}} active={currentMode ==1}/>
                        <CircularTextButton title={"Graduated"} callback={() => {sendPatternChangeCommand(1)}} active={currentMode ==0}/>
